...
abstract class BaseListFragmentVBVMVMSelf<DES : Any, VB : ViewBinding, VMSELF : BaseListViewModel<DES>, VMSHARE : BaseViewModel> : BaseFragmentVBVMVMSelf<VB, VMSHARE, VMSELF>(), IListActivity<DES> {

    private val _listProxy by lazy_ofNone { ListProxy<DES>(this).apply { bindLifecycle(this@BaseListFragmentVBVMVMSelf) } }
