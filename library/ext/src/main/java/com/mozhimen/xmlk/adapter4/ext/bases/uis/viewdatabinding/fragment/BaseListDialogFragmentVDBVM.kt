...
abstract class BaseListDialogFragmentVDBVM<DES : Any, VDB : ViewDataBinding, VM : BaseListViewModel<DES>>() : BaseDialogFragmentVDBVM<VDB, VM>(), IListActivity<DES> {

    private val _listProxy by lazy_ofNone { ListProxy<DES>(this).apply { bindLifecycle(this@BaseListDialogFragmentVDBVM) } }
