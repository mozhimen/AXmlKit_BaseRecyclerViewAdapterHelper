...
abstract class BaseListFragmentVDBVM<DES : Any, VH : BaseViewHolder, VB : ViewBinding, VM : BaseListViewModel<DES>>() : BaseFragmentVBVM<VB, VM>(), IListActivity<DES> {

    private val _listProxy by lazy_ofNone { ListProxy<DES>(this).apply { bindLifecycle(this@BaseListFragmentVDBVM) } }
