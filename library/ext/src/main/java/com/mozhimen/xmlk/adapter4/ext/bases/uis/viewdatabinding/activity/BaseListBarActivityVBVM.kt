...
abstract class BaseListBarActivityVBVM<DES : Any, VDB : ViewDataBinding, VM : BaseListViewModel<DES>> : BaseBarActivityVDBVM<VDB, VM>(), IListActivity<DES> {
    ...
    override fun initLayout() {
        super.initLayout()
        _listProxy.initLayout(this@BaseListBarActivityVBVM)
    }
