...
abstract class BaseListDialogFragmentVBVMSelf<DES : Any, VB : ViewBinding, VM : BaseListViewModel<DES>>() : BaseDialogFragmentVBVMSelf<VB, VM>(), IListActivity<DES> {

    private val _listProxy by lazy_ofNone { ListProxy<DES>(this).apply { bindLifecycle(this@BaseListDialogFragmentVBVMSelf) } }
