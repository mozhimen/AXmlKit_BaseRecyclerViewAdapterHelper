...
abstract class BaseListFragmentVBVM<DES : Any, VB : ViewBinding, VM : BaseListViewModel<DES>>() : BaseFragmentVBVM<VB, VM>(), IListActivity<DES> {

    private val _listProxy by lazy_ofNone { ListProxy<DES>(this).apply { bindLifecycle(this@BaseListFragmentVBVM) } }
