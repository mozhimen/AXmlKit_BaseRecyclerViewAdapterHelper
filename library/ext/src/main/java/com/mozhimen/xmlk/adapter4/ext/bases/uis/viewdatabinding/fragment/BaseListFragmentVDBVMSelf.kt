...
abstract class BaseListFragmentVDBVMSelf<DES : Any, VDB : ViewDataBinding, VM : BaseListViewModel<DES>>: BaseFragmentVDBVMSelf<VDB, VM>(), IListActivity<DES> {

    private val _listProxy by lazy_ofNone { ListProxy<DES>(this).apply { bindLifecycle(this@BaseListFragmentVDBVMSelf) } }
