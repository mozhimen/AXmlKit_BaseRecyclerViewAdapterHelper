...
/**
 * @ClassName BaseListDialogFragmentVBVMSelf
 * @Description TODO
...
abstract class BaseListDialogFragmentVDBVMSelf<DES : Any, VDB : ViewDataBinding, VM : BaseListViewModel<DES>>() : BaseDialogFragmentVDBVMSelf<VDB, VM>(), IListActivity<DES> {

    private val _listProxy by lazy_ofNone { ListProxy<DES>(this).apply { bindLifecycle(this@BaseListDialogFragmentVDBVMSelf) } }
