...
abstract class BaseListDialogFragmentVDBVMVMSelf<DES : Any, VDB : ViewDataBinding, VMSELF : BaseListViewModel<DES>, VMSHARE : BaseViewModel> : BaseDialogFragmentVDBVMVMSelf<VDB, VMSHARE, VMSELF>(), IListActivity<DES> {

    private val _listProxy by lazy_ofNone { ListProxy<DES>(this).apply { bindLifecycle(this@BaseListDialogFragmentVDBVMVMSelf) } }
