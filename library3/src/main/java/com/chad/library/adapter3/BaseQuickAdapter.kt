...
import com.chad.library.adapter3.animation.*
import com.chad.library.adapter3.diff.BrvahAsyncDiffer
import com.chad.library.adapter3.diff.BrvahAsyncDifferConfig
import com.chad.library.adapter3.diff.BrvahListUpdateCallback
import com.chad.library.adapter3.listener.*
import com.chad.library.adapter3.module.*
...
@JvmOverloads constructor(
     ...
     * 改变某一位置数据
     */
    open fun setData(@IntRange(from = 0) index: Int, data: T, payload: Any?) {
        if (index >= this.data.size) {
            return
        }
        this.data[index] = data
